...
void minymay(char *cad); /* Prototipo de función. Modificación "*" añadido*/
...
void main(void)
{
    ...
    for (i=0; i<n; i++)
    {
        ...
        //fflush(stdin); <--- Modificado (no funciona)
        gets(FRA[i]);
    }
    printf("\n\n");
    for (i=0; i<n; i++)
...
/* Esta función se utiliza para calcular el numero de minusculas
