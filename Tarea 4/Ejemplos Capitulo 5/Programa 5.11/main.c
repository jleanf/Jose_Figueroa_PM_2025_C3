...
void Lectura(int *, int); /* Prototipos de funciones. */ //Modificación: asterisco
...
void main(void)
{
    ...
    if (RES)
        /* Si RES tiene un valor verdadero —diferente de 0—, se escribe la posición en la que se
...
/* Esta función se utiliza para realizar una búsqueda binaria del elemento E en el arreglo
unidimensional A de T elementos. Si se encuentra el elemento, la función regresa la posición
