...
/* Esta función se utiliza tanto para calcular el módulo entre el índice delarreglo unidimensional
y 3, como para llamar a las funcionescorrespondientes para resolver el problema. */
{
    int I;
    for (I=0; I<N; I++)
        switch (I%3)
