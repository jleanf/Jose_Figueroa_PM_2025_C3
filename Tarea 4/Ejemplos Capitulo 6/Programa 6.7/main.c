...
obtiene información estadística valiosa para la empresa. */

void Lectura1(int [15][12]);
void Lectura2(float *, int); //Modificación: asterisco
...
/* Esta función se utiliza para almacenar en el arreglo bidimensional las diferentes transacciones
que representan las ventas de los diferentes productos. El fin de datos está dado por –1. */
{
    int MES, PRO, CAN;
