...
void Lectura(float A[][MES][ANO], int F, int C, int P) //Modificación: Lectur ---> Lectura
...
/* Esta función se utiliza para localizar la provincia que tuvo el mayor registro de precipitación
pluvial en los últimos 10 años. Escribe además el registro correspondiente. */
{
    int I, K, J, EMAY = -1;
    float ELLU = -1.0, SUM;
    for (I=0; I<F; I++)
