...
El programa, al recibir un arreglo tridimensional que contiene información sobre las ventas mensuales
...
/* La función Lectura se utiliza para leer un arreglo tridimensional de tipo real de
